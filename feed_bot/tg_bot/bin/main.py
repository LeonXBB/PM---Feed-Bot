            ...
            if layout is not None:
                ...
                for row in layout:
                    ...
                    for button in row:
                        ...
                        callback_formatter = data[4][len(keyboards) - 1][i] if data[4] is not None and len(data[4]) >= len(keyboards) and data[4][len(keyboards) - 1] is not None and len(data[4][len(keyboards) - 1]) > i else list()
