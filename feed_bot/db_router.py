routes = {
    "default": ("Action", "CoinToss", "Competition", "Event", "EventTemplate", "EventTemplateEdit", "Period", "Point", "RulesSet", "SideChange", "Team", "TimeOut", "Timer", "TextString", "TextLanguage", "PasswordPair", "BotUser", "ScheduledMessage", "APIMessage"),
